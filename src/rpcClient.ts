...
export class RpcClient {
	...
	// Get block by height
	async getBlockByHeight(height = 1): BlockModel {
	...
	// Get last N blocks
	async getRecentBlocks(options: { limit, maxHeight, minHeight }): BlockModel[] {
	...
	async getTransactionByHash(rawHash: string): TxModel {
	...
	async searchByQuery(params: ISearchByQuery): object {
		params = {
